...
const BlogPage = () => {
  ...
  return (
    <div className="bg-gray-100">
      <div className="max-w-[1550px]  p-4 rounded-lg mx-auto pt-10 grid grid-cols-10 gap-2">
        <aside className="sticky top-20 h-[calc(100vh-4rem)]  p-4 rounded-lg col-span-1 mt-20">
          <div className="flex flex-col items-end justify-center gap-12 mr-3">
        ...
        <main className="py-4 px-12 bg-white col-span-7 rounded-lg ">
          <h2 className="text-start text-4xl mt-4 mb-8 font-semibold">
            My Blog Post
          </h2>
          <div>
        ...
        <aside className="h-[calc(100vh-20rem)] p-4 rounded-lg col-span-2 bg-white">
